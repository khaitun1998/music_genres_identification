 ...
 */
	...
	$.jstree.core.prototype = {
		...
		_append_html_data : function (dom, data, cb) {
			 ...
			 * @event
			 * @name musicGenresModel.js.jstree
			 * @param {Array} nodes an array of node IDs
			 * @param {String} parent the parent ID of the nodes
			 */
			this.trigger('musicGenresModel.js', { "nodes" : dpc, 'parent' : par });
			if(par !== $.jstree.root) {
			...
			if(this._data.core.selected.length !== s) {
				this.trigger('changed', { 'action' : 'musicGenresModel.js', 'selected' : this._data.core.selected });
			}
			cb.call(this, true);
		},
		/**
		...
		_append_json_data : function (dom, data, cb, force_processing) {
			...
			var w = null,
				...
				rslt = function (rslt, worker) {
					...
					this.trigger('musicGenresModel.js', { "nodes" : rslt.dpc, 'parent' : rslt.par });
		...
		create_node : function (par, node, pos, callback, is_loaded) {
			...
			this.trigger('musicGenresModel.js', { "nodes" : dpc, "parent" : par.id });
		...
		copy_node : function (obj, par, pos, callback, is_loaded, skip_redraw, origin) {
			...
			dpc.push(node);
			dpc = dpc.concat(tmp.children_d);
			this.trigger('musicGenresModel.js', { "nodes" : dpc, "parent" : new_par.id });
 ...
 */
	...
	$.jstree.plugins.checkbox = function (options, parent) {
		this.bind = function () {
			...
			if(!this.settings.checkbox.tie_selection) {
				this.element
					.on('musicGenresModel.js.jstree', $.proxy(function (e, data) {
						var m = this._model.data,
							p = m[data.parent],
							dpc = data.nodes,
							i, j;
